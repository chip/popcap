require 'spec_helper'
require 'mayfly/formatters/filesize'
  ...
  module Formatters
    describe Filesize do
      ...
      it 'handles floats' do
        ...
        expect(fs.format_filesize).to eq '1.2K'
      end

      it 'returns nil for nil' do
        fs = Filesize.new(nil)
        expect(fs.format_filesize).to be_nil
      end
